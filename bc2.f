...
c     no-slip (u = v = 0, dp/dx = 0) 
      do j = 1-mbc, my+mbc
         do ibc=1,mbc
			...
			q(4,1-ibc,j) = q(4,ibc,j)
			q(5,1-ibc,j) = q(5,ibc,j)
			q(6,1-ibc,j) = q(6,ibc,j)
		 enddo
      enddo
...
c     no-slip (u = v = 0, dp/dx = 0) 
      do j = 1-mbc, my+mbc
         do ibc=1,mbc
			...
			q(4,mx+ibc,j) = q(4,mx+1-ibc,j)
			q(5,mx+ibc,j) = q(5,mx+1-ibc,j)
			q(6,mx+ibc,j) = q(6,mx+1-ibc,j)
		 enddo
      enddo
...
c     no-slip (u = v = 0, dp/dy = 0) 
      do jbc=1,mbc
	     do i = 1-mbc, mx+mbc
			...
			q(4,i,1-jbc) = q(4,i,jbc)
			q(5,i,1-jbc) = q(5,i,jbc)
			q(6,i,1-jbc) = q(6,i,jbc)
		 enddo
      enddo
...
c     no-slip (u = 1, v = 0, dp/dy = 0) 
      do jbc=1,mbc
	     do i = 1-mbc, mx+mbc
			...
			q(4,i,my+jbc) = q(4,i,my+1-jbc)
			q(5,i,my+jbc) = q(5,i,my+1-jbc)
			q(6,i,my+jbc) = q(6,i,my+1-jbc)
		 enddo
      enddo
