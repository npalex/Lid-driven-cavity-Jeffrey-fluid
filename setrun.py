...
#    probdata.add_param('E' , 0.1, 'Elasticity number')
    ...
    # There are  two coupled equations, 
    #   q(3,:,:) and q(4,:,:) are used to store the pressure and divergence
    clawdata.num_eqn = 7
    ...
    clawdata.num_waves = 5    # exclude waves from the two longitudinal modes
